...
class MoviesTest < ApplicationSystemTestCase
  ...
  test "should create movie" do
    ...
    fill_in "Language of the movie", with: @movie.Language_of_the_movie
    fill_in "Movie description", with: @movie.Movie_Description
    fill_in "Movie director name", with: @movie.Movie_Director_name
